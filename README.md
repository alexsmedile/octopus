...
<img src="docs/assets/mental-model.svg" width="100%" alt="Mental model — octopus orchestrates activities; each activity holds tasks, sessions, memory, and handoffs."/>
...
<img src="docs/assets/scaffold.svg" width="100%" alt="Folder scaffold — what an .octopus/ directory looks like on disk."/>
...
<img src="docs/assets/pipeline.svg" width="100%" alt="Five-bucket pipeline — backlog → next → now → done, with dropped as a side exit."/>
...
<img src="docs/assets/lifecycle.svg" width="100%" alt="Task lifecycle — capture, focus, start, block, unblock, finish."/>
...
<img src="docs/assets/axes.svg" width="100%" alt="Five axes — pipeline, domain workflow, runtime, attention, impediment."/>
